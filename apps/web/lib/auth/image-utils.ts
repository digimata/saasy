// -------------------------------------------------
// projects/saasy/apps/web/lib/auth/image-utils.ts
//
// export async function resizeAndCropImage()     L9
// async function loadImage()                    L40
// export async function fileToBase64()          L56
// -------------------------------------------------
