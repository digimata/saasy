...
import type { TeamOptions, TeamOptionsContext } from "@/lib/auth/types/team-options"
...
export const AuthUIProvider = ({
    ...
    const defaultMutators = useMemo(() => {
        return {
            deleteApiKey: (_params: any) => Promise.resolve(null), // TODO: apiKey plugin not enabled
            deletePasskey: (_params: any) => Promise.resolve(null), // TODO: passkey plugin not enabled
    ...
    const defaultHooks = useMemo(() => {
        return {
            ...
            useListPasskeys: () => ({ data: null, error: null, isPending: false }), // TODO: passkey plugin not enabled
            useListApiKeys: () => ({ data: null, error: null, isPending: false }), // TODO: apiKey plugin not enabled
    ...
    return (
        ...
        >
            ...
            {/* RecaptchaV3 commented out — component not yet available */}
            {children}
        </AuthUIContext.Provider>
    )
}
