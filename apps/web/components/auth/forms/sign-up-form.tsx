// ---------------------------------------
// projects/saasy/apps/web/components/auth/forms/sign-up-form.tsx
//
// export interface SignUpFormProps    L55
//   className                         L56
//   classNames                        L57
//   callbackURL                       L58
//   isSubmitting                      L59
...
//   redirectTo                        L61
//   setIsSubmitting                   L62
//   passwordValidation                L63
// export function SignUpForm()        L79
// export async function signUp()      L79
// ---------------------------------------
...
import { cn, getLocalizedError, getPasswordSchema, getSearchParam } from "@/lib/auth/utils";
              ...
              render={() => (
                <FormItem>
                  ...
                  <div className="flex items-center gap-4">
                    <DropdownMenu>
                      <DropdownMenuTrigger className="size-fit rounded-full cursor-pointer">
                        <UserAvatar
