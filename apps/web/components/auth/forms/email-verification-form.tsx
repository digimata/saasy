// --------------------------------------------------
// projects/saasy/apps/web/components/auth/forms/email-verification-form.tsx
//
// export interface EmailVerificationFormProps    L43
//   className                                    L44
//   classNames                                   L45
//   callbackURL                                  L46
//   isSubmitting                                 L47
...
//   setIsSubmitting                              L51
//   onCancel                                     L52
// export function EmailVerificationForm()        L55
// export async function resendCode()             L55
// export async function verifyCode()             L55
// --------------------------------------------------
    ...
    return (
      <div className={cn("grid w-full gap-6", className)}>
        <div className="text-center">
          <h2 className="font-semibold text-destructive text-lg">Invalid Request</h2>
